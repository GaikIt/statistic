            ...
            <table className="w-full">
                ...
                <tbody>{
                    ...
                    <tr key={idx}>
                        ...
                        <td className={transactions.type==='income'? 'text-green-500' : 'text-red-500'}>{transactions.type === 'income' ? 
                        `+ ${formatToRUB.format(transactions.amount)}` : `- ${formatToRUB.format(transactions.amount)}`}</td>
